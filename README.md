Bootstrap with [Create React App](https://github.com/facebookincubator/create-react-app) project for building React applications using [Redux](http://redux.js.org/) as a framework.
